...
import 'package:travel_app/airline/home_bottom_nav/controller/flight_qoute_controller.dart';
import 'package:travel_app/airline/booking_history/view/my_bookings_screen.dart';
import 'package:travel_app/airline/home_bottom_nav/views/flight_details.dart';
...
class _SearchFlightScreenState extends State<SearchFlightScreen>  with TickerProviderStateMixin {
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: DatePicker(
                                  ...
                                  height: 30,
                                  width: 68,
                                  initialSelectedDate: DateTime.parse(widget.departDate),
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: DatePicker(
                                  ...
                                  height: 30,
                                  width: 68,
                                  initialSelectedDate: DateTime.parse(widget.arriveDate),
                                  selectionColor: Colors.black,
                                  selectedTextColor: Colors.white,
                                  dayTextStyle: TextStyle(fontSize: 8, fontWeight: FontWeight.bold),
                                  monthTextStyle: TextStyle(fontSize: 8, fontWeight: FontWeight.w600),
