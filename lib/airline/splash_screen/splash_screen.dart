...
import 'package:travel_app/airline/splash_screen/onboard_screen.dart';
        ...
        child: Column(
          ...
          children: [
            Container(
                ...
                child: Image(filterQuality: FilterQuality.high, image: AssetImage("assets/icons/logo.png"), fit: BoxFit.contain)),
          ],
        ),
      ),
    );
