...
import '../controller/search_hotel_PNR_controller.dart';
import '../controller/share_booking_controller.dart';
import '../model/search_hotel_PNR_model.dart';

class SearchHotelPNRScreen extends StatefulWidget {
  const SearchHotelPNRScreen({super.key});

  @override
  State<SearchHotelPNRScreen> createState() => _SearchPNRScreenState();
}

class _SearchPNRScreenState extends State<SearchHotelPNRScreen> {
  final searchController = TextEditingController();
  final SearchHotelPNRController searchPNRController =
      Get.put(SearchHotelPNRController());
  final Rx<SearchHotelPNRModel> searchPNRModel = SearchHotelPNRModel().obs;
  final RxList<SearchHotelPNRModel> PNRList = <SearchHotelPNRModel>[].obs;
