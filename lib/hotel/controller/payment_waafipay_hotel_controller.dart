...
class WaafiBookingHotelController extends GetxController {
      ...
      passengers.add(
        {
          ...
          "requestedAge": calculateAge(child1dob),
          "birthDate": child1dob,
          "Title": "MISTER",
          "email": email,
          "phoneCountryCode": phoneCode,
      ...
      passengers.add(
        {
          ...
          "requestedAge": calculateAge(child2dob),
          "birthDate": child2dob,
          "Title": "MISTER",
          "email": email,
          "phoneCountryCode": phoneCode,
      ...
      passengers.add(
        {
          ...
          "requestedAge": calculateAge(child3dob),
          "birthDate": child3dob,
          "Title": "MISTER",
          "email": email,
          "phoneCountryCode": phoneCode,
      ...
      passengers.add(
        {
          ...
          "requestedAge": calculateAge(child4dob),
          "birthDate": child4dob,
          "Title": "MISTER",
          "email": email,
          "phoneCountryCode": phoneCode,
      ...
      passengers.add(
        {
          ...
          "requestedAge": calculateAge(infant1dob),
      ...
      passengers.add(
        {
          ...
          "requestedAge": calculateAge(infant2dob),
      ...
      passengers.add(
        {
          ...
          "requestedAge": calculateAge(infant3dob),
      ...
      passengers.add(
        {
          ...
          "requestedAge": calculateAge(infant4dob),
