...
class PassengerDetailsHotelScreen extends StatefulWidget {
  String searchID;
  String hotelID;
  String roomID;
  //
  ...
  @override
  State<PassengerDetailsHotelScreen> createState() => _PassengerDetailsHotelScreenState();
}

class _PassengerDetailsHotelScreenState extends State<PassengerDetailsHotelScreen> {
                  ...
                  onPress: () {
                    if (_formkey.currentState!.validate()) {
                      setState(() {
                        ...
                        Get.to(() => PaymentMethodHotelScreen(
                              roomID: widget.roomID,
