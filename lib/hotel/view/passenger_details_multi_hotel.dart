...
import 'package:travel_app/hotel/view/payment_method_hotel.dart';
import 'package:travel_app/hotel/view/payment_method_multi_hotel.dart';
...
class PassengerDetailsMultiHotelScreen extends StatefulWidget {
  ...
  PassengerDetailsMultiHotelScreen({
    super.key,
    required this.rooms,
  ...
  @override
  State<PassengerDetailsMultiHotelScreen> createState() => _PassengerDetailsMultiHotelScreenState();
}

class _PassengerDetailsMultiHotelScreenState extends State<PassengerDetailsMultiHotelScreen> {
                  ...
                  onPress: () {
                    if (_formkey.currentState!.validate()) {
                      setState(() {
                        ...
                        Get.to(() => PaymentMethodMultiHotelScreen(
                              rooms: widget.rooms,
                              multiAccom: widget.multiAccom,
