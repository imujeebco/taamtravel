...
class PaymentMethodHotelScreen extends StatefulWidget {
  String searchID;
  String hotelID;
  String roomID;
  //
...
//
  ...
  @override
  State<PaymentMethodHotelScreen> createState() => _PaymentMethodHotelScreenState();
}

class _PaymentMethodHotelScreenState extends State<PaymentMethodHotelScreen> {
                              ...
                              onPress: () {
                                if (selectedID == "") {
                                  ...
                                  if (selectedOption == "Waafi Pay") {
                                    ...
                                    Get.to(() => PaymentWaafiHotelScreen(
