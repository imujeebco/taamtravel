...
import 'package:travel_app/airline/home_bottom_nav/controller/payment_method_controller.dart';
import 'package:travel_app/app/configs/app_size_config.dart';
import 'package:travel_app/hotel/controller/hotel_booking_controller.dart';
import 'package:travel_app/hotel/view/payment_waafi_hotel_screen.dart';
import 'package:travel_app/hotel/view/payment_waafi_multi_hotel_screen.dart';
...
import '../../airline/home_bottom_nav/controller/agency_balace_controller.dart';
import '../../airline/home_bottom_nav/controller/flight_booking_controller.dart';
import '../../airline/home_bottom_nav/model/payment_method_model.dart';
import '../model/booking_request.dart';
import 'Hotel_tabs/search_room_model.dart';

// ignore: must_be_immutable
class PaymentMethodMultiHotelScreen extends StatefulWidget {
...
//
  ...
  @override
  State<PaymentMethodMultiHotelScreen> createState() => _PaymentMethodMultiHotelScreenState();
}

class _PaymentMethodMultiHotelScreenState extends State<PaymentMethodMultiHotelScreen> {
  ...
  String selectedID = '';
  final HotelBookingController hotelBookingController =
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Obx(() {
          return hotelBookingController.isLoading.value
              ? Center(
                              ...
                              onPress: () {
                                if (selectedID == "") {
                                  ...
                                  if (selectedOption == "Waafi Pay") {
                                    ...
                                    Get.to(() => PaymentWaafiMultiHotelScreen(
                                          rooms: widget.rooms,
                                    ...
                                    widget.rooms.forEach((room) {
                                      hotelBookingController.fetchBooking(
