...
class PaymentWaafiHotelScreen extends StatefulWidget {
  String searchID;
  String hotelID;
  String roomID;
  String paymentID;
...
//
  ...
  @override
  State<PaymentWaafiHotelScreen> createState() => _PaymentWaafiHotelScreenState();
}

class _PaymentWaafiHotelScreenState extends State<PaymentWaafiHotelScreen> {
